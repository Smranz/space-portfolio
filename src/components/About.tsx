                    ...
                    >
                        <div className="w-[300px] h-[400px] md:w-[350px] md:h-[450px] relative overflow-hidden group">
                            ...
                            <div
                                ...
                                style={{
                                    maskImage: "radial-gradient(circle 60px at var(--x) var(--y), black 95%, transparent 100%)",
                                    WebkitMaskImage: "radial-gradient(circle 60px at var(--x) var(--y), black 95%, transparent 100%)",
                                }}
                            >
                                <NextImage
